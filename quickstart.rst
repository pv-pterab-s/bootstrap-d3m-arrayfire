...
-  Documentation of the whole D3M program:
   `https://datadrivendiscovery.org <https://datadrivendiscovery.org>`__
-  Common primitives:
...
-  Docker images:
   `https://datadrivendiscovery.org/docker.html <https://datadrivendiscovery.org/docker.html>`__
...
You can find the list of D3M docker images `here <https://datadrivendiscovery.org/docker.html>`__.
...
though - just modify the ``stable`` part accordingly):
